...
class City(Base):
    ...
    # 层级关系
    parent_id = Column(Integer, ForeignKey('cities.code'), nullable=True, comment='父级ID')
    ...
    # 自关联关系
    parent = relationship('City', remote_side=[code], backref='children',foreign_keys=[parent_id])  # 明确指定外键)
